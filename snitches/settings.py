...
class BaseMission(ABC):
    ...
    def get_modal(self, **kwargs):
        ...
        menu.add.image(IMAGE_URLS[self.snitch.name], scale=(settings.SCALE_FACTOR / 10, settings.SCALE_FACTOR / 10))
...
class Snitch:
    def __init__(self, name, missions: [BaseMission], next_snitch):
        self.name = name
